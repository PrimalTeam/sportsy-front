          ...
          child: Padding(
            ...
            child: Column(
              ...
              RadioListTile(
                ...
                onChanged: (value) {
                  setState(() {
                    selectedRole = value!; // Aktualizacja wybranej wartości
                  });
                },
              ),
              RadioListTile(
                title: const Text("Role Game Observer" , style: TextStyle(color: Colors.white)),
                value: RoomUserRoleEnum.gameObserver.name, // Wartość dla tego przycisku
                groupValue: selectedRole, // Aktualnie wybrana wartość
                onChanged: (value) {
                  setState(() {
                    selectedRole = value!; // Aktualizacja wybranej wartości
